...
//   4. Chain `when:` expression syntax - a chain step's routing condition
...
// ---------------------------------------------------------------------------
// Check 4 - chain `when:` expression syntax. A chain step can route on a score
...
module.exports = { analyzeCheckout, parseSteps, validateChainWhen };
